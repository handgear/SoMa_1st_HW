...
import com.handgear.multimemo.common.TitleBackgroundButton;
...
import static com.handgear.multimemo.BasicInfo.DateFormat;
import static com.handgear.multimemo.BasicInfo.TwitInstance;
...
//    	insert_handwritingBtn = (TitleBitmapButton)findViewById(R.id.insert_handwritingBtn);
		...
		tweetEnable = (ToggleButton)findViewById(R.id.tweetEnable);
...
//		});
		...
		tweetEnable.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		   @Override
		   public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
			   if(isChecked){
				   isTweetEnabled = true;
				   Toast.makeText(getBaseContext(), "tweet enabled" , Toast.LENGTH_LONG).show();
			   }
			   else{
				   isTweetEnabled = false;
				   Toast.makeText(getBaseContext(), "tweet disabled" , Toast.LENGTH_LONG).show();
			   }
		   }
	    });
			...
			public void onClick(View v) {
                ...
                if (isParsed) {
                	if(mMemoMode.equals(BasicInfo.MODE_INSERT)) {
                		saveInput();
						if(isTweetEnabled == true){
							updateStatus(mMemoStr);
						}
